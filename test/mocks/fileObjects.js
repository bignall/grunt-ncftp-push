...
module.exports = {
  'test': {
    'files': [{
      ...
      "src": ['test/tasks/utils.js'],
      "info": [{'path': 'test/tasks/utils.js', 'isDir': false}],
      "dest": 'test/tasks/utils.js',
      "orig": {
          "expand": true,
          "cwd": 'tasks',
          "src": ['**/*'],
      ...
      'src': ['test/utils.js'],
      'info': [{'path': 'test/utils.js', 'isDir': false}],
      'dest': 'test/tasks/utils.js',
      "orig": {
        "expand": true,
        "cwd": 'tasks',
    ...
    'paths': [{
      ...
      'src': ['tasks/ftp_push.js', 'tasks/utils.js'],
      'dest': '/html/test/test',
      'isDir': false
    }, {
      'src': ['test/utils.js'],
      'dest': '/html/test/tasks',
      ...
      'src': [ 'test/tasks/utils.js' ],
      'dest': '/html/test/test/test/tasks',
      'isDir': false
    }],
    'relativeDestResult': {
      'src': [ 'tasks/utils.js' ],
    ...
    'multipleSrcFileResult': {
      'src': ['test/utilsTest.js', 'test/fileObjects.js'],
      'dest': '/html/test',
      'isDir': false
    },
    'base': '/html/test/',
    ...
    'command': [
      ...
      ['ncftpput  -m -f .ftpauth -r 3 /html/test test/utilsTest.js test/fileObjects.js']
    ]
  }
};
